                    ...
                    <div id="divToPrint">
                        ...
                        <div class="topPrintHeadMain">
                            ...
                            <div class="billDateGroop">
                                <!-- <br clear="all"> -->
                                <!-- <h2 style="text-align:center">The West Bengal State Co-operative Marketing Federation
                                    Ltd.</h2>
                                <h4 style="text-align:center">Southend Conclave, 3rd Floor,1582 Rajdanga Main
                                    Road,Kolkata - 700 107.</h4> -->
                                ...
                                <div class="billDateGroop">
                                    <div class="dateTop">Date:
                                        <strong><?php echo  date("d-m-Y", strtotime($key1->trans_dt));?></strong>.</div>
                                </div>
                                <br clear="all">
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <table width="100%" class="table tableCus">
                                                        <thead>
                                                            <tr>
                                                                <th align="left" scope="row" class="double_1">
                                                                    Particulars</th>
                                                                <th align="left" scope="row" class="double_2">Amount
                                                                </th>
                                                            </tr>
                                                            <?php
                                                        $tot_amount=0.00;
