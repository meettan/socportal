		...
		<div class="twoColomSec">
			...
			<div class="reportBoxMain">
				...
				<div class="reportBoxMainList">
					<div class="imgsec"><img src="{{ url('public/images/society_icon.png') }}" alt=""/></div>
				...
				<div class="col-sm-4 float-left">
				<div class="reportBoxMainList">
					<div class="imgsec"><img src="{{ url('public/images/perchase_icon.png') }}" alt=""/></div>
				...
				<div class="col-sm-4 float-left">
				<div class="reportBoxMainList">
					<div class="imgsec"><img src="{{ url('public/images/payment_icon.png') }}" alt=""/></div>
